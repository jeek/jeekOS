...
export class SimpleServer {
	...
	get backdoorInstalled() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).backdoorInstalled;
			} catch (e) {
				return false;
			}
		})();
	...
	get cpuCores() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).cpuCores;
			} catch (e) {
				return false;
			}
		})();
	...
	get ftpPortOpen() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).ftpPortOpen;
			} catch (e) {
				return false;
			}
		})();
	...
	get httpPortOpen() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).httpPortOpen;
			} catch (e) {
				return false;
			}
		})();
	...
	get isConnectedTo() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).isConnectedTo;
			} catch (e) {
				return false;
			}
		})();
	...
	get numOpenPortsRequired() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).numOpenPortsRequired;
			} catch (e) {
				return 6;
			}
		})();
	...
	get openPortCount() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).openPortCount;
			} catch (e) {
				return -1;
			}
		})();
	...
	get purchasedByPlayer() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).purchasedByPlayer;
			} catch (e) {
				return -1;
			}
		})();
	...
	get smtpPortOpen() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).smtpPortOpen;
			} catch (e) {
				return false;
			}
		})();
	...
	get sqlPortOpen() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).sqlPortOpen;
			} catch (e) {
				return false;
			}
		})();
	...
	get sshPortOpen() {
		return (async () => {
			try {
				return ((await Do(this.ns, "ns.getServer", this.name))! as Server).sshPortOpen;
			} catch (e) {
				return false;
			}
		})();
