    ...
    async raiseHacking(level: number) {
        if ((await Do(this.ns, "ns.getPlayer")).skills["hacking"] < level) {
            ...
            while ((await Do(this.ns, "ns.getPlayer")).skills["hacking"] < level) {
                await Do(this.ns, "ns.singularity.universityCourse", "ZB Institute of Technology", "Algorithms", (!((await Do(this.ns, "ns.singularity.getOwnedAugmentations", false))!.includes("Neuroreceptor Management Implant"))));
    ...
    async raiseCharisma(level: number) {
        if ((await Do(this.ns, "ns.getPlayer")).skills["charisma"] < level) {
            ...
            while ((await Do(this.ns, "ns.getPlayer")).skills["charisma"] < level) {
                await Do(this.ns, "ns.singularity.universityCourse", "ZB Institute of Technology", "Leadership", (!((await Do(this.ns, "ns.singularity.getOwnedAugmentations", false))!.includes("Neuroreceptor Management Implant"))));
                await this.ns.asleep(1000);
            }
            Do(this.ns, "ns.singularity.stopAction");
        }
    ...
    async raiseStrength(level: number) {
        if ((await Do(this.ns, "ns.getPlayer")).skills["strength"] < level) {
            ...
            while ((await Do(this.ns, "ns.getPlayer")).skills["strength"] < level) {
                await Do(this.ns, "ns.singularity.gymWorkout", "Powerhouse Gym", "Strength", (!((await Do(this.ns, "ns.singularity.getOwnedAugmentations", false))!.includes("Neuroreceptor Management Implant"))));
                await this.ns.asleep(1000);
            }
            Do(this.ns, "ns.singularity.stopAction");
        }
    ...
    async raiseDefense(level: number) {
        if ((await Do(this.ns, "ns.getPlayer")).skills["defense"] < level) {
            ...
            while ((await Do(this.ns, "ns.getPlayer")).skills["defense"] < level) {
                await Do(this.ns, "ns.singularity.gymWorkout", "Powerhouse Gym", "Defense", (!((await Do(this.ns, "ns.singularity.getOwnedAugmentations", false))!.includes("Neuroreceptor Management Implant"))));
                await this.ns.asleep(1000);
            }
            Do(this.ns, "ns.singularity.stopAction");
        }
    ...
    async raiseDexterity(level: number) {
        if ((await Do(this.ns, "ns.getPlayer")).skills["dexterity"] < level) {
            ...
            while ((await Do(this.ns, "ns.getPlayer")).skills["dexterity"] < level) {
                await Do(this.ns, "ns.singularity.gymWorkout", "Powerhouse Gym", "Dexterity", (!((await Do(this.ns, "ns.singularity.getOwnedAugmentations", false))!.includes("Neuroreceptor Management Implant"))));
                await this.ns.asleep(1000);
            }
            Do(this.ns, "ns.singularity.stopAction");
        }
    ...
    async raiseAgility(level: number) {
        if ((await Do(this.ns, "ns.getPlayer")).skills["agility"] < level) {
            ...
            while ((await Do(this.ns, "ns.getPlayer")).skills["agility"] < level) {
                await Do(this.ns, "ns.singularity.gymWorkout", "Powerhouse Gym", "Agility", (!((await Do(this.ns, "ns.singularity.getOwnedAugmentations", false))!.includes("Neuroreceptor Management Implant"))));
                await this.ns.asleep(1000);
            }
            Do(this.ns, "ns.singularity.stopAction");
        }
